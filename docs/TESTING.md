...
The current suite contains 62 domain tests, 34 application tests, and 16
Infrastructure integration tests. Azure DevOps runs tests with cross-platform
coverage collection for feature branches, `dev`, and `main`.
